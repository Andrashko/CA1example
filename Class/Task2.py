...
# ▪ визначення вказаної кількості вільних місць за умови, що нових жильців  приймати не будуть.
...
vizyt = Hotel("Візит", "***", [Service("Спа", 1000, 2), Service("Музка", 250, 1), Service("Басейн", 100, 0.5), Service("Зал", 150, 3)],
...
print(vizyt.calcToPayForRoom(6000))